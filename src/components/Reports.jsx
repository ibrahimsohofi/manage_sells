...
const Reports = ({ sales }) => {
  ...
  const getMonthlyChartData = () => {
    ...
    sales.forEach(sale => {
      ...
      if (saleDate.getFullYear() === selectedYear) {
        ...
        monthlyData[month] += sale.totalPrice;
        monthlyQuantity[month] += sale.quantity || 1;
  ...
  const getDailyChartData = () => {
    ...
    sales.forEach(sale => {
      ...
      if (saleDate.getFullYear() === selectedYear && saleDate.getMonth() === selectedMonth) {
        ...
        dailyData[day] += sale.totalPrice;
        dailyQuantity[day] += sale.quantity || 1;
      }
    });
  ...
  const getCategoryChartData = () => {
    ...
    sales.forEach(sale => {
      ...
      categoryData[sale.category] += sale.totalPrice;
    });
