            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div><span className="font-medium">Montant Total:</span> {selectedCustomer.totalAmount.toFixed(2)} MAD</div>
                  <div><span className="font-medium">Panier Moyen:</span> {
                    selectedCustomer.totalPurchases > 0
                      ? (selectedCustomer.totalAmount / selectedCustomer.totalPurchases).toFixed(2)
                      : '0.00'
                  } MAD</div>
